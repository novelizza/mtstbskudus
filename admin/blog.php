                ...
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                <div class="row">
                                    <a class="btn btn-block" href="tambah-blog.php"
                                        style="background-color: #4ECB71; float: right;"><span
                                            style="color: white;">Tambah Blog / Artikel</span></a>
                                </div>
                            </h5>
                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">1</th>
                                        <td>MTS NU TBS Kudus jadi madrasah terbaik nomor satu di jawa tengah</td>
                                        <td>Lorem ipsum dolor sit amet lorem ipdum dolor sit amet lorem ipsum dolor sit
                                            amet ...</td>
                                        <td>
                                            <a href="edit-blog.php" class="btn btn-warning btn-sm btn-block">Edit</a>
                                            <button class="btn btn-danger btn-sm btn-block" data-bs-toggle="modal"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Yakin Hapus Artikel Ini?</h5>
