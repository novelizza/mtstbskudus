                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="section-headline text-center">
                            <h2><span style="color: #4ECB71;">Profil</span> Madrasah</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-10 col-xs-12">
                        ...
                        <a class="sus-btn" href="profilmadrasah.php">Lihat Selengkapnya</a>
                    </div>
                    <!-- End col-->
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="section-headline services-head text-center">
                            <h2><span style="color: #4ECB71;">Program</span> Unggulan</h2>
                        </div>
                    </div>
                </div>
          ...
          <div class="swiper-wrapper"> -->
                <div class="swiper-slide">
                    <div class="testimonial-item">
                        ...
                        <h2>Madrasah Tsanawiyah NU Tasywiquth Thullab Salafiyah Kudus</h2>
                        <a href="ppdb/login.php" class="ready-btn scrollto">Daftar Sekarang</a>
                    </div>
                </div>
                <!--</div>
        </div> -->
