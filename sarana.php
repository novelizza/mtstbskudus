        ...
        <div id="about" class="about-area area-padding">
            <div class="container">
                ...
                <div class="section-headline text-center">
                    <h2><span style="color: #4ECB71;">Sarana &</span> Prasarana</h2>
                </div>
                <!-- </div> -->
            </div>
            <!-- ======= Visi Section ======= -->
            <div id="testimonials" class="testimonials-kelas">
                <div class="container">
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <h1 style="text-align: left;">Ruang Kelas</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="testimonials" class="testimonials-kom">
                <div class="container">
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <h1 style="text-align: left;">Laboratorium Komputer</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- ======= Tujuan Section ======= -->
            <div id="testimonials" class="testimonials-bhs">
                <div class="container">
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <h1 style="text-align: left;">Laboratorium Bahasa</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="testimonials" class="testimonials-ekstra">
                <div class="container">
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <h1 style="text-align: left;">Ekstrakulikuler</h1>
                        </div>
                    </div>
                </div>
            </div>
